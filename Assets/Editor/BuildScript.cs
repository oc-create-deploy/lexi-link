...
public static class BuildScript
{
    public static void BuildIos()
    {
        ...
        const string appIconPath = "Assets/Brand/LexiLink-AppIcon.png";
        Directory.CreateDirectory(outputPath);

        PlayerSettings.companyName = "Playable Games";
        PlayerSettings.productName = "Lexi Link";
        PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.iOS, "com.play.wordcon");
